<div class='flex-col content-center mt-5 '>
    <div class="rounded-xl border p-5 ml-10 mr-10 shadow-md w-8/8 bg-white items-center" >
        ...
        <div class="flex justify-between ">
            ...
            <div class="mt-12 mr-5 border-2 p-5 ml-12 hover:bg-gray-50 flex flex-col items-center">
